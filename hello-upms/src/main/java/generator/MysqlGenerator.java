...
public class MysqlGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://120.55.54.42:11987/hello?useUnicode=true&useSSL=false&characterEncoding=utf8");
...
//        mpg.setTemplate(new TemplateConfig().setXml(null));
        ...
        strategy.setSuperEntityClass("com.he.helloupms.common.BaseEntity");
        strategy.setEntityLombokModel(true);
        strategy.setSuperControllerClass("com.he.helloupms.common.BaseController");
