...
import com.he.hellocommon.common.ResultConstant;
...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        return null;
//        Result<UserDto> userResult = userService.findByUsername(username);
//        if (userResult.getCode() != ResultConstant.SUCCESS.getCode()) {
...
//        Result<List<RoleDto>> roleResult = roleService.getRoleByUserId(userResult.getData());
